<footer class="bg-body border-top py-4">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4 mb-3 mb-md-0">
                <h5 class="mb-3">About ConZone</h5>
                <p class="text-muted">ConZone is a community forum for gamers to discuss all things related to PC, console, and mobile gaming. Join the conversation today!</p>
            </div>
            ...
            <div class="col-md-2 mb-3 mb-md-0">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/rules" class="text-muted">Rules</a></li>
            ...
            <div class="col-md-3 mb-3 mb-md-0">
                ...
                <ul class="list-unstyled text-muted">
                    <li><i class="bi bi-envelope me-2"></i> support@conzone.com</li>
                    <li><i class="bi bi-telephone me-2"></i> (123) 456-7890</li>
                    <li><i class="bi bi-geo-alt me-2"></i> 123 Gaming Street, Pixel City</li>
                </ul>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="/" class="text-muted me-3 d-inline-flex align-items-center">
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <p class="text-muted mb-0">&copy; 2024 ConZone. All rights reserved.</p>
            </div>

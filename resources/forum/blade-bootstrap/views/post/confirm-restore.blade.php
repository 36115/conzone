...
@section('page') {{ trans_choice('forum::posts.restore', 1) }} @endsection
@section ('content')
    <div id="delete-post">
        ...
        <form method="POST" action="{{ Forum::route('post.restore', $post) }}">
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary rounded-pill px-5">{{ trans('forum::general.restore') }}</button>
            </div>
        </form>
    </div>
@stop
